...
class FormMenuScore(Form):
    def __init__(self, name,screen, x, y, w, h, color_background, color_border, active, path_image, scoreboard, margen_y,margen_x, espacio):
        super().__init__(name,screen, x,y,w,h,color_background,color_border,active)
        ...
        self.lista_widgets.append(
            Label(screen=self._slave, x=margen_x+10,y=20,w=w/2-margen_x,h=50,text = "Jugador", font="Verdana",font_size=30,font_color=(255,255,255),path_image=r"assets\graphics\interfaz\bar.png"))
        self.lista_widgets.append(
            Label(screen=self._slave,
                x=margen_x+10+w/2-margen_x,
                y=20,w=w/2-margen_x,
                h=50,text = "Puntaje",
                font="Verdana",
                font_size=30,
                font_color=(255,255,255),
                path_image="assets/graphics/interfaz/bar.png"))
