...
class Stage:
    def __init__(self, screen: pygame.surface.Surface, limit_w, limit_h, stage_name: str):
        ...
        self.player_sprite = Player(limit_w / 2, 487, limit_h, speed=10, stage_dict_configs=self.__configs, gravity = 16, jump = 32 )  # posicion inicial
    ...
    def controlar(self):
        self.player_sprite.manejar_eventos_teclado()
