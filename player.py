...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, constraint, speed):
        ...
        self.image = pygame.image.load('assets/graphics/player_allen/stand.png').convert_alpha()
    ...
    def create_bullet(self):
        return Bullet(self.rect.x, self.rect.top) # Crea y devuelve un objeto de la clase Bullet en la posición actual del ratón
